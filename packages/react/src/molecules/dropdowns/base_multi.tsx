              ...
              {({ active }) => (
                <Menu as="div" className="relative block">
                  ...
                  <Transition
                    ...
                    leaveTo="transform opacity-0 scale-95"
                  >
                    <Menu.Items className="absolute right-0 top-0 w-56 origin-top-left translate-x-full rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
                        <Menu.Item>
                          {({ active }) => (
                            <a
